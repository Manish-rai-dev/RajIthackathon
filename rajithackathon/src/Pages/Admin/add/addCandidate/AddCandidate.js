...
function AddCandidate() {
  ...
  const [formErrorssection, setformErrorssection] = useState({});
  ...
  const handleFocussection =(e)=>{
    setFocused(true);
    setformErrorssection(validatesection);
  }
      ...
      <img src={Group} alt="group" className="groupadmin " />
            ...
            <div className="row">
              {/* <div className="col-lg-6"> */}
                ...
                {/* <span className="error_msg">{formErrorssection.year}</span> */}
              {/* </div> */}
              ...
              <div className="col-lg-6">
                ...
                <span className="error_msg messages_err">{formErrorssection.section}</span>
              </div>
            </div>
            ...
            <div className="row">
              ...
              className="inputCandidate">
                <InputLabel id="demo-simple-select-label" className="inputCandidate">subject</InputLabel>
                <Select
                sx={{ width: { sm: 200, md: 210 } }}
                  labelId="demo-simple-select-label"
                  id="demo-simple-select"
